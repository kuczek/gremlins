...
=== ":material-debian: deb"
    ...
    the [release page](https://github.com/kuczek/gremlins/releases/latest), then install with:
...
```sh
go install github.com/kuczek/gremlins/cmd/gremlins@v{{ release.full_version }}
```
...
the [release page](https://github.com/kuczek/gremlins/releases/latest), then:
